...
app = Flask(__name__)
CORS(app, origins=["https://filesharing-iota.vercel.app"])

app.config['SECRET_KEY'] = 'password'
# app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///flaskdb.db'
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://exljnr:hmInD3Jc239BLIUKCrtSJYxk9cDnBwLF@dpg-co4nfksf7o1s738uftsg-a.oregon-postgres.render.com/backend_8f2a'
...
PARENT_FOLDER_ID ="1KQWI0piTXSAhEKZp7cOHyUir_yHQezwd"
...
def register_outletPartner():
    ...
    if outlet_exists:
        ...
        new_outlet = Outlet(outletName=outletName, outletOwnerName=outletOwnerName,
